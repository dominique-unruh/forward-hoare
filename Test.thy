...
(* TODO: should be handled by program-command *)
  ...
  do_prf \<open>add_hoare3 \<^binding>\<open>step1\<close> NONE (Demo_Hoare_Logic.ex_range (0,1)) "start"
  ...
  do_prf \<open>add_hoare3 \<^binding>\<open>step2\<close> NONE (Demo_Hoare_Logic.ex_range (1,2)) "step1"
  ...
  do_prf \<open>add_hoare3 \<^binding>\<open>step3\<close> NONE (Demo_Hoare_Logic.ex_range (2,3)) "step2"
